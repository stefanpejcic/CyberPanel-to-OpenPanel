...
```
git clone https://github.com/stefanpejcic/CyberPanel-to-OpenPanel.git
```

```
bash CyberPanel-to-OpenPanel/cp-import.sh --backup-location=/path/to/cyberpanel_backup.file --plan-name='Standard plan'
```
